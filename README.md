...
しかし、従来の新規事業開発——市場調査に時間をかけ、PowerPointで完璧な計画を作り、<br>
承認を得てから開発を始めるスタイル——は、もはや「遅すぎる」のではなく「間違っている」のです。<br>
...
**Depth & Velocity** は、新規事業開発における「誰が・何をやるか」を根本から再定義する方法論です。

- **最初の10%（The Will）：** 「なぜやるのか」を定義できるのは人間だけ。狂気に近い意志だけが、プロジェクトに初速を与える。
- **真ん中の80%（The Acceleration）：** リサーチ、分析、プロトタイピング、コーディング、検証。AIエージェントがすべてを加速する。数ヶ月が数日になる。
- **最後の10%（The Decision）：** 世に出すかどうかを決めるのは人間。倫理的責任。出す勇気と、止める勇気。

## 3つの原則

### 1. 考えてから作るのではなく、作りながら考えよう。

事業計画書のプレゼンを磨き上げるのをやめて、動くプロトタイプを作ろう。<br>
バイブコーディングは、新規事業開発担当者の最強の武器だ。<br>
プロトタイプが、市場が本当に求めているものを教えてくれる。<br>
AIがプロトタイプ開発コストをほぼゼロコストで可能にした。素晴らしい時代の到来だ。<br>

### 2. タスクではなく、コンテキストを管理しよう。

AI時代に管理すべきは「文脈（コンテキスト）」<br>
— 会議のログ、ユーザーインタビュー、市場シグナル。<br>
すべてを「Project Brain」に投げ込め。AIエージェントが即座に引き出す。

### 3. 動くプロトタイプで経営会議をハックしよう。

企業のイノベーションを殺す最大の敵は、市場ではない。 **「承認ゲート」** だ。<br>
経営層は、自分が評価出来ないもの、理解できないものを却下する。<br>
スライドだけを持って行くのではなく、動くプロトタイプを持って行こう。<br>
— スマートフォンで動くアプリを持っていけ。会議室の空気が「批評」から「伴走者」に変わる。
