...
```mermaid
graph TD
    A["<b>The 10:80:10 Rule</b><br/>The Base OS of Thinking"] --> B["Critical Thinking<br/>Question and guide AI"]
    A --> C["Four Prompt Levers<br/>Extracting expertise"]
    A --> D["Primary Intelligence × LLM<br/>Hypothesis validation cycle"]
    A --> E["Context<br/>Engineering"]
    A --> F["Prototype Driven<br/>Hack executives with<br/>working prototypes"]
    A --> G["Project Brain<br/>Process as an asset"]
...
```mermaid
graph TD
    A["<b>The First 10%: The Will</b><br/>──────────────<br/>Owner: Human<br/>Will and Questions (Deep Will)<br/>'Why are we doing this?'<br/>'Who are we doing this for?'<br/>AI cannot participate"]
    B["<b>The Middle 80%: The Acceleration</b><br/>──────────────<br/>Owner: AI<br/>Research, Analysis, Coding<br/>Prototyping, Validation<br/>──────────────<br/>Human: Orchestrate<br/>Review, Redirect, Add Context"]
    C["<b>The Last 10%: The Decision</b><br/>──────────────<br/>Owner: Human<br/>Final go/no-go judgment<br/>Ethical responsibility"]
...
```mermaid
graph TD
    A["1. Pose a question or hypothesis to the LLM"] --> B["2. LLM returns output"]
    B --> C["3. Evaluate with critical thinking<br/>Appropriate? Factual? Logically sound?<br/>What is the basis? Are there alternative interpretations?"]
    C --> D["4. Identify errors or gaps, articulate them,<br/>and feed back to the LLM"]
    D --> E["5. LLM understands feedback and<br/>returns improved output<br/>+ deeper understanding of user intent and context"]
    E --> F["6. Evaluate again with critical thinking<br/>Repeat dialogue until satisfied"]
    F -->|"Not satisfied"| C
    F -->|"Satisfied"| G["7. Deep learning and<br/>high-quality output achieved"]
...
```mermaid
graph LR
    A["◆ Expert Knowledge<br/>(Rare, High-Value)<br/>What we actually need"]
    B["▲ Average Response<br/>(High frequency)<br/>What vague prompts produce"]
    C["◆ Expert Knowledge<br/>(Rare, High-Value)<br/>What we actually need"]

    A -.-|"Shift exploration range<br/>with Four Prompt Levers"| B
    B -.-|"Shift exploration range<br/>with Four Prompt Levers"| C
...
```mermaid
graph TD
    A["<b>1. Set hypothesis/question</b><br/>Human: The First 10%<br/>'This customer segment should<br/>have this pain point'"] --> B["<b>2. Validate hypothesis</b><br/>Go to the field, meet customers<br/>Show prototypes<br/>Observe reactions"]
    B --> C["<b>3. Acquire primary intelligence</b><br/>What did the customer say?<br/>How did they react?<br/>What interested them and what didn't?"]
    C --> D["<b>4. Input primary intelligence into LLM</b><br/>Leverage as a thinking partner<br/>'Are there any insights I'm<br/>overlooking in these results?'"]
    D --> E["<b>5. Update hypothesis</b><br/>Evolve to a more precise hypothesis<br/>Design next validation action"]
    E --> A
...
```mermaid
graph LR
    A["Prompt 1<br/>+ context v1.0"] --> B["Output 1"]
    B --> C["Update to context v1.1"]
    C --> D["Prompt 2<br/>+ context v1.1"]
    D --> E["Output 2"]
    E --> F["Update to context v1.2"]
    F --> G["Prompt 3<br/>+ context v1.2"]
    G --> H["Output 3"]
...
```mermaid
graph LR
    subgraph "Traditional Presentation"
        A["PowerPoint<br/>Excel<br/>Business Plans"] --> B["System 2 activated<br/>(Critical mode)"]
        B --> C["Cognitive Load ↑<br/>Searching for 'reasons to say No'"]
    end

    subgraph "Prototype Driven"
        D["Hand over a<br/>working prototype"] --> E["System 1 activated<br/>(Intuitive mode)"]
        E --> F["Cognitive Ease ↑<br/>Feeling 'this is interesting'"]
    end
...
graph LR
    subgraph "0→1 Phase"
        A["<b>Primary Intelligence (Raw Data)</b><br/>██████████<br/>Importance: Maximum<br/>AI summarization prohibited<br/>Preserve all raw data"]
    end
    subgraph "1→10 Phase"
        B["<b>Primary + Summaries Combined</b><br/>█████░░░░░<br/>After concept is confirmed<br/>Gradually streamline"]
    end
    subgraph "10→100 Phase"
        C["<b>Summary-Centric</b><br/>░░░░░█████<br/>Dashboard operations<br/>KPI tracking"]
    end
...
```mermaid
graph TD
    A["<b>The 10:80:10 Rule</b><br/>The Base OS of Thinking<br/>(Chapter 2)"]

    A --> B["Critical Thinking<br/>Question and Guide AI<br/>(Chapter 3)"]
    A --> C["Four Prompt Levers<br/>Extracting Expertise<br/>(Chapter 4)"]
    A --> D["Primary Intelligence × LLM<br/>Reaching Beyond Training Data<br/>(Chapter 5)"]
    A --> E["Context Engineering<br/>Perpetuating Context<br/>(Chapter 6)"]
    A --> F["Prototype Driven<br/>Hacking Executives<br/>(Chapter 7)"]
    A --> G["Project Brain<br/>Process as an Asset<br/>(Chapter 8)"]

    B --> H["<b>Build to Think</b><br/>(Chapter 9)"]
    C --> H
    D --> H
    E --> H
    F --> H
